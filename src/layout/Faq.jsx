export default function Faq() {
  return (
    <>
      ...
      <h3>Do you give price quotes via email or phone?</h3>
      <p>
      ...
      <p>
        {/*add link to contact page*/}Begin booking by filling out our contact
        form with basic information about your desired tattoo. We will respond
        within 1-3 business days. After an artist responds to your request, you
        can email them with reference photos and a design description. All
        tattoo appointments require a deposit. Once a date and time are agreed
        upon, you will be directed to complete our deposit form to secure your
        appointment.
      </p>
